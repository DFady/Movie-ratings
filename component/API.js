...
const API = () => {
    ...
    const baseUrl = "https://api.themoviedb.org/3/search/movie?api_key=8c4c1b910e7daf21eac5aac9cf5786c2&language=fr&query=  ";
            ...
            <View>
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View>
                            <Pressable onPress={() => {
                                navigation.navigate("Les détails du film", { title: item.title, resume: item.resume, comment: item.comment, rating: item.rating, image: item.image });
                            }}>
